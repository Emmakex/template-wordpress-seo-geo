...
- Pilot status: **production baseline + UNKNOWN review complete; Portable Clone export is accepted through authenticated delivery/retention in 0.8.14; Portable Import intake + destination preflight is active in 0.8.15, and `/nuevaweb/` sandbox acceptance remains pending**
