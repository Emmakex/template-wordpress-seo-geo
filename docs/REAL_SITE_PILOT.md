...
- Pilot status: **production baseline + UNKNOWN review complete; Portable Clone export is accepted through 0.8.14 and import intake/preflight through 0.8.15; 0.8.16 full private payload verification is active before database restore, while `/nuevaweb/` sandbox acceptance remains pending**
