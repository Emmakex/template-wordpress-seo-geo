...
- Pilot status: **production baseline + UNKNOWN review complete; Portable Clone export is accepted through 0.8.14, import intake/preflight through 0.8.15, full payload verification through 0.8.16 and transactional database staging through 0.8.17; destination file staging is active in 0.8.18, while `/nuevaweb/` sandbox acceptance remains pending**
