...
Status: **active — 10E.2A.4.1 through 10E.2A.4.3 are accepted; 10E.2A.4.4 verified staging-file restore is the Migration Bridge 0.8.18 candidate**
...
- **10E.2A.4.4 — file restore:** active in 0.8.18; copy only manifest-backed uploads/plugins/themes from the checksum-verified private extraction into `import/staged-files`, never active `wp-content`; batches are resumable and a second independent SHA-256 traversal must reconcile exact file/byte totals before completion.
