...
- Migration Bridge v0.8.7 is merged/accepted for the sandbox step and adds a strict preflight: distinct origin, explicit sandbox/outbound/backups markers, search visibility off, destination Theme active, baseline/dependency graph available and all raw UNKNOWN items reviewed;
