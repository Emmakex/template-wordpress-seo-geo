...
foreach (
	array(
		"/'package_id'\\s*=>/",
		"/'site_url'\\s*=>/",
		"/'database'\\s*=>\\s*\\x24this->empty_payload_class/",
		"/'uploads'\\s*=>\\s*\\x24this->empty_payload_class/",
		"/'plugins'\\s*=>\\s*\\x24this->empty_payload_class/",
		"/'themes'\\s*=>\\s*\\x24this->empty_payload_class/",
