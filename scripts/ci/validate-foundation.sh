...
required_paths=(
  ...
  "packages/seo-geo-core/src/Language/NativeTranslationRelationshipResolver.php"
  "packages/seo-geo-core/src/Language/TranslationRelationship.php"
  ...
  "scripts/ci/native-translation-smoke.sh"
