...
printf 'Foundation contract OK: %d required paths present plus all five Phase 7 preset contracts, the Phase 8A/8B Migration Bridge safety contract and minimum-sufficient CI scope.\n' "${#required_paths[@]}"
