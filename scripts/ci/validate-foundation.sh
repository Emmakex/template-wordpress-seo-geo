...
required_paths=(
  ...
  "packages/seo-geo-migration-bridge/src/IncrementalBaselineStore.php"
  "packages/seo-geo-migration-bridge/src/IncrementalBaselineCapture.php"
  ...
  "packages/seo-geo-migration-bridge/src/Sandbox/SandboxHandoffManifest.php"
  ...
  "packages/seo-geo-migration-bridge/src/Operator/AdminBaselineCaptureController.php"
  "packages/seo-geo-migration-bridge/src/Operator/AdminSandboxHandoffController.php"
  ...
  "release/stable-release-decision.json"
  ...
  "scripts/ci/validate-stable-release-decision.py"
  "scripts/ci/validate-product-portfolio.py"
  ...
  "scripts/ci/migration-bridge-incremental-baseline-acceptance.sh"
  ...
  "scripts/build-migration-bridge-release.py"
  "scripts/ci/migration-bridge-release-acceptance.py"
  ".github/workflows/migration-bridge-release.yml"
