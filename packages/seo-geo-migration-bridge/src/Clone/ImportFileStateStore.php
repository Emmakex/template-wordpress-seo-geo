<?php
/**
 * Portable Clone resumable staging-file restore state.
 *
...
/**
 * Stores bounded non-autoloaded file-staging progress.
 */
final class ImportFileStateStore {
	...
	/**
	 * Return one normalized file-restore state.
	 *
	...
	/**
	 * Persist one bounded file-restore state.
	 *
	 * @param string              $job_id Clone job identifier.
	...
	/**
	 * Normalize one bounded traversal path.
	 *
	...
	/**
	 * Normalize one directory-entry cursor.
	 *
