...
/**
 * Stores bounded parent-state for local-clone private extraction/checksum replay.
 */
final class LocalClonePayloadVerificationStateStore {
	public const OPTION_NAME    = 'seo_geo_migration_local_clone_payload_verification_v1';
	...
	private function normalize_state( string $job_id, array $state ): ?array {
		...
		return array(
			...
			'child_restore_allowed'        => true === ( $state['child_restore_allowed'] ?? false ),
