	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'baseline_progress_notice' => 'Progress saved. The next small batch will start automatically; if the connection closes, return here and continue safely.',
			...
			'es' => array(
				...
				'baseline_progress_notice' => 'Progreso guardado. El siguiente lote pequeño se iniciará automáticamente; si se corta la conexión, vuelve aquí y continúa de forma segura.',
