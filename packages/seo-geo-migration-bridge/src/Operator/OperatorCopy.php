	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'baseline_capture_button'        => 'Capture SEO/GEO baseline',
				'baseline_capture_help'          => 'This explicit action anonymously reads same-origin public URLs and stores only the Migration Bridge baseline. It does not change the theme, plugins, content, permalinks, or public SEO output.',
			...
			'es' => array(
				...
				'baseline_capture_button'        => 'Capturar línea base SEO/GEO',
				'baseline_capture_help'          => 'Esta acción explícita lee de forma anónima URLs públicas del mismo origen y guarda únicamente la línea base del Puente de migración. No cambia el tema, plugins, contenido, enlaces permanentes ni la salida SEO pública.',
