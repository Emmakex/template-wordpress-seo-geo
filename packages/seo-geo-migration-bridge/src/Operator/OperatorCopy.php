	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'sandbox_preflight_help'         => 'Migration can run only after every isolation and recovery guard below is satisfied on a distinct non-production origin.',
				...
				'label_distinct_origin'          => 'Distinct non-production origin',
			...
			'es' => array(
				...
				'sandbox_preflight_help'         => 'La migración solo puede ejecutarse cuando todas las protecciones de aislamiento y recuperación estén cumplidas en un origen no productivo distinto.',
				...
				'label_distinct_origin'          => 'Origen no productivo distinto',
