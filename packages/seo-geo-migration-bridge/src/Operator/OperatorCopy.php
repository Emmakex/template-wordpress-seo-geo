	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'intro'                          => 'Review migration status and the safest next step. Viewing this screen is read-only. The explicit baseline action only captures and stores bounded public SEO/GEO evidence; it does not execute migration, cutover, rollback, or report persistence actions.',
				...
				'dependency_detail_help'         => 'UNKNOWN items are shown first so they can be reviewed before sandbox migration. This table is read-only and contains planning metadata only.',
				'sandbox_handoff_heading'        => 'Sandbox handoff',
				'sandbox_handoff_help'           => 'Download a privacy-bounded JSON manifest with baseline identity, runtime metadata and dependency decisions. It does not contain post bodies, builder payloads, credentials, database dumps or uploads.',
				...
				'privacy_text'                   => 'This screen shows bounded status metadata only. Baseline capture uses anonymous same-origin public requests and stores fingerprints/SEO signals, not post bodies, builder payloads, credentials, or raw recovery artifacts.',
			...
			'es' => array(
				...
				'intro'                          => 'Revisa el estado de la migración y el siguiente paso más seguro. Consultar esta pantalla es de solo lectura. La acción explícita de línea base solo captura y guarda evidencia pública SEO/GEO acotada; no ejecuta migración, cambio a producción, reversión ni persistencia del informe.',
				...
				'dependency_detail_help'         => 'Los elementos UNKNOWN aparecen primero para revisarlos antes de migrar en sandbox. Esta tabla es de solo lectura y contiene únicamente metadatos de planificación.',
				'sandbox_handoff_heading'        => 'Entrega al sandbox',
				'sandbox_handoff_help'           => 'Descarga un manifiesto JSON acotado por privacidad con la identidad de la línea base, metadatos del runtime y decisiones de dependencias. No incluye cuerpos de entradas, cargas de constructores, credenciales, volcados de base de datos ni uploads.',
				...
				'privacy_text'                   => 'Esta pantalla muestra únicamente metadatos de estado acotados. La captura de línea base usa solicitudes públicas anónimas del mismo origen y guarda huellas/señales SEO, no cuerpos de entradas, cargas de constructores, credenciales ni artefactos de recuperación en bruto.',
