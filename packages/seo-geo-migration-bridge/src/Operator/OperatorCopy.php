	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'clone_help'                     => 'Phase 10E.2A.1 creates resumable planning jobs only. It does not copy database rows or files yet.',
			...
			'es' => array(
				...
				'clone_help'                     => 'La fase 10E.2A.1 crea únicamente trabajos reanudables de planificación. Todavía no copia filas de base de datos ni archivos.',
