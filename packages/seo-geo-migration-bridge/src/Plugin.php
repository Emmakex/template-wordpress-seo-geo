...
final class Plugin {
	...
	/**
	 * Portable Clone import payload verification state singleton.
	 *
	...
	/**
	 * Portable Clone import payload verifier singleton.
	 *
	...
	public static function boot(): void {
		...
		self::$clone_import_payload_verifier    ??= new ImportPayloadVerifier(
