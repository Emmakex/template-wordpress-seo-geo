...
- bundled declarative preset packages plus an allowlisted preset registry; Corporate and Local Business are complete and Publisher is the third Phase 7 preset in progress, with all presets disabled by default;
