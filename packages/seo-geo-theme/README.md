...
- bundled declarative preset packages plus an allowlisted preset registry; Corporate and Local Business are complete Phase 7 presets, with all presets disabled by default;
