...
- bundled declarative preset packages plus an allowlisted preset registry; Corporate is complete and Local Business is the second Phase 7 preset, with all presets disabled by default;
