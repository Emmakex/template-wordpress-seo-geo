	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'read_only_notice'            => 'Preview does not save. Apply setup persists only validated theme/Core options and a non-sensitive report; it does not create pages, install plugins or request external credentials. No SEO/GEO plugin is required for baseline setup.',
			...
			'es' => array(
				...
				'read_only_notice'            => 'La previsualización no guarda. Aplicar configuración persiste solo opciones validadas del tema/Core y un informe no sensible; no crea páginas, instala plugins ni solicita credenciales externas. No se requiere ningún plugin SEO/GEO para la configuración base.',
