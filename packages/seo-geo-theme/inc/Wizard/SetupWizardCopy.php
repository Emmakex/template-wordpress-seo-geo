	...
	public static function catalogs(): array {
		return array(
			'en' => array(
				...
				'zero_plugin_notice'          => 'Baseline onboarding is self-contained: no SEO/GEO plugin is required.',
			...
			'es' => array(
				...
				'zero_plugin_notice'          => 'El onboarding base es autocontenido: no requiere ningún plugin SEO/GEO.',
