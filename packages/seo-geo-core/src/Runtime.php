...
use SeoGeo\Core\Language\NativeTranslationRelationshipResolver;
...
final class Runtime {
	...
	/**
	 * Native reciprocal translation resolver.
	 *
	 * @var NativeTranslationRelationshipResolver|null
	 */
	private static ?NativeTranslationRelationshipResolver $translations = null;
	...
	public static function initialize(): void {
		...
		self::$translations = new NativeTranslationRelationshipResolver( $language_configuration );
	...
	/**
	 * Get the validated native translation resolver when initialized.
	 */
	public static function translations(): ?NativeTranslationRelationshipResolver {
